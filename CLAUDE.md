...
Active session plan: two-tier punch list, agreed with Simon 2026-08-15 — **RC1 bar: cleared** (#241 fixed and merged; Simon's real-database validation still outstanding but non-blocking for the codebase itself). **v1.0.0 public bar:** finish M7 sub-projects 1-4 (sub-project 1 still paused mid-fix-wave, see above), plus resolve #242. **Before broader new build work, still review the open-issue backlog (was 103 as of 2026-08-15, now +4 from #241's follow-ups, net +3 since #241 itself closed) — Simon flagged this previously and it has only grown.** See Expiry for the refresh trigger on this subsection.
